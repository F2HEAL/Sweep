## 🧩 Full Script: `sweep_CH_Vol_Freq_diff_ON_OFF_3BL_progi_lsl.py`
...
def do_measurement(com, inlet, config, channel, frequency, volume,
    ...
    for cycle in range(1, cycles + 1):
        ...
        record_to_csv(inlet, on_dur, fname, marker=11)
        com.stop_stream()
...
def main():
    ...
    try:
        ...
        record_to_csv(inlet, config.baseline_1, fname1, marker=34)
